...
return {
  ...
  apply(ctx) {
    ...
    /**
     * 我方 marker id 前缀清单(NEW markers 用第一个;其余是历史插件名,改名后仍须能识别)。
     *
    ...
    /**
     * 第 2 段(遮蔽载体)判定:user/message + replace + 我方 marker id。
    ...
    /** 第 1 段事件(或它的 data)是否带我方可识别的审计形状。 */
     ...
     * @param {object} carrier - 候选载体事件(`user/message` + replace + 我方 marker id)
