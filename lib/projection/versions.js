...
export const versionsViewSchema = z.object({
  ...
  // How many host-side surface replacements were filtered out of `versions`
  // (see viewVersionIndex). Surfaced so the view can say "另有 N 条…" instead
  // of hiding them silently.
  hostReplacementCount: z.number().int().nonnegative(),
})
