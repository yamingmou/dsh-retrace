 ...
 *     扫描会话事件视图：turn/start 开、turn/end 关；尾部仍开 = 未闭合。
 */
import { sessionEvents, sessionIds } from './host-compat.js'

/**
 * 扫描会话，找未闭合的轮次。
 * @param {object} session - DSH session 对象（事件视图由 host-compat 访问器给出）。
