 ...
 *
 *     <pluginDataHome>/dsh-retrace/objects/<sha256[:2]>/<sha256>
 *
 * where `<pluginDataHome>` is whatever `lib/platform/session-paths.js`
 * `pluginDataHome()` resolves ($DSH_HOME when set; otherwise the active session
 * base, i.e. the same home the sessions are read from — see that module).
 *
