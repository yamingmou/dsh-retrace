...
/**
 * 短会话豁免阈值（2026-08-31 独立审查问题 B，2026-09-01 用户实测调大）：
 * surface 节点 ≤ 20（≈ 10 轮 ≈ 20 条消息）的会话不做回档幅度拦截——
 * 否则 4-7 轮小会话撤回/编辑 100% 被拒（用户实测「一共没几个对话,点击就提示
 * 遮蔽 100%」）。事故防御针对**大会话**的「编辑早期消息遮蔽几十轮」，
 * 20 条以内的小会话无此风险。与 client 侧 SHADOW_MIN_ROWS_FOR_RATIO 同源。
 */
