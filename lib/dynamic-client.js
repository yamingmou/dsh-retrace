...
return {
  ...
  apply(ctx) {
    const mod = (() => {
      ...
      var CONFIG_DEFAULTS = { version: CONFIG_VERSION, showOriginalInput: true, editFromScratch: false, hideShadowed: false, versioning: true, git: true, retentionLimit: 50, prewrite: true };
      ...
      function TimelinePanel({ sessionId, useSession, useProjection, useSessions, t, ctx }) {
        ...
        return (0, import_react.createElement)("div", { className: "dsh-rt-timeline", ref: rootRef }, [
          (0, import_react.createElement)("button", {
            key: "trigger",
            ref: triggerRef,
            type: "button",
          ...
          open && (0, import_react.createElement)("div", {
            ...
            style: panelPos ? { top: `${panelPos.top}px`, right: `${panelPos.right}px` } : void 0
          }, [
