  ...
  apply(ctx) {
    const mod = (() => {
      ...
      var zh = {
        ...
        "timeline.detail": "\u8BE6\u60C5",
        "timeline.jump": "\u8DF3\u8F6C",
        "timeline.jumpFailed": "\u8BE5\u4F4D\u7F6E\u7684\u5386\u53F2\u6D88\u606F\u5C1A\u672A\u52A0\u8F7D\uFF0C\u8BF7\u5148\u52A0\u8F7D\u66F4\u65E9\u6D88\u606F",
      ...
      var en = {
        ...
        "timeline.jump": "Jump",
        "timeline.jumpFailed": "This part of history is not loaded yet; load earlier messages first",
      ...
      var CONFIG_DEFAULTS = { showOriginalInput: true, editFromScratch: true, hideShadowed: true, versioning: true, git: true, retentionLimit: 50 };
      ...
      function TimelinePanel({ sessionId, useSession, useProjection, useSessions, t, ctx }) {
        ...
        return (0, import_react.createElement)("div", { className: "dsh-rt-timeline", ref: rootRef }, [
          ...
          open && (0, import_react.createElement)("div", { key: "panel", className: "dsh-rt-timeline-panel" }, [
